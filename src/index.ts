...
const plugin: JupyterFrontEndPlugin<void> = {
  ...
  activate: async (app: JupyterFrontEnd, palette: ICommandPalette) => {
    ...
    const newWidget = async () => {
      ...
      let img = document.createElement('img'); // create a new HTML <img> element
      content.node.appendChild(img); // add it to the Widget DOM node
    ...
    const command: string = 'apod:open'; //* command id
